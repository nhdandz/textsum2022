...
text = """sThe US Treasury Department on Tuesday sanctioned Russian President Vladimir Putin's reputed girlfriend as part of a series of measures targeting Russian elites in the Biden administration's latest attempt to punish the Kremlin for its ongoing war in Ukraine.
...
import itertools
print(type(list(t)))
t = list(str(k) for k,_ in itertools.groupby(list(t)))
print(t)